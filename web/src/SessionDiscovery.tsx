      ...
      <div className="search-row">
        ...
        <details className="filter-panel" ref={panelRef}>
          ...
          <div className="filter-grid">
            <label>Sessions
              <select value={filters.scope} onChange={(event) => onChange({ ...filters, scope: event.target.value as SessionFilters["scope"] })}>
            ...
            <div className="filter-actions">
              <button className="secondary clear-filters" type="button" disabled={!count} onClick={() => onChange({ query: "", scope: "normal", provider: "", repository: "", statuses: [], dateRange: "all", dateFrom: "", dateTo: "", pinnedOnly: false, hidden: "visible", sort: "relevance" })}>Clear filters</button>
...
export function SessionSearchResults({
  ...
  onRestore?: (session: VisibleSession["session"]) => void;
}) {
